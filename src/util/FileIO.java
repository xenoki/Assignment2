...
public class FileIO
{
    ...
    */
    private void readBasePrice(Automotive model, String[] data) throws AutoException
    {
        try 
        {
            model.setPrice(Integer.parseInt(data[PRICE].trim()));
        } 
        catch (ArrayIndexOutOfBoundsException e) 
        {
    ...
    */
    private void readOptionSet(Automotive model, String[] data, BufferedReader buffer) throws AutoException
    {
        ...
        try 
        {
            model.addOptionSet(data[OPTION_SET]);

        } catch (ArrayIndexOutOfBoundsException e) 
        {
            throw new AutoException("File does not contain a OptionSet Name", 
                    AutoException.NO_OPTIONSET_NAME);
        }
        ...
        try 
        {
            ...
            {   
                ...
                {   
                    ...
                    model.addOption(data[OPTION_SET], 
